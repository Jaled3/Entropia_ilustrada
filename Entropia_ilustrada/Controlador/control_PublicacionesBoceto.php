...
/*Cargar solo las publicaciones Boceto del Usuario Seleccionado*/
function cargarPublicacionesBocetosUsuario() {
    ...
    /*Cargar todas las publicaciones boceto de un usuario en específico*/
    $lista = $pub->publicacionesBocetoIdUsuario($idUsu, 0, 10);
...
if (isset($_GET['action']) && $_GET['action'] == 'getPosts') {
    ...
    $pub = new publicaciones();
    $lista = $pub->publicacionesBocetoIdUsuario($idUsu, $offset, $limit);
