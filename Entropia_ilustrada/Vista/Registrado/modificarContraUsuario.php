<main>
    ...
    <section class="h-190 mx-auto flex items-center justify-center bg-[url(../ServidorImg/libreria.jpg)] bg-no-repeat bg-cover bg-gray-700 bg-blend-multiply">           
        <div class="w-full max-w-sm p-4 bg-gray-800 border border-gray-700 rounded-lg shadow-sm sm:p-6 md:p-8">
            <form class="space-y-6" action="../Controlador/control_perfilUsuario.php?action=cambiarContraUsuario" method="POST">
