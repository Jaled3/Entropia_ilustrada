<main>
    ...
    <section class="h-200 sm:h-150 flex flex-col justify-center bg-fixed bg-center bg-no-repeat bg-[url('../ServidorImg/estanteria.jpg')] bg-gray-700 bg-blend-multiply">
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <div class="flex flex-col justify-center my-10">
                ...
                <h2 class="text-xl drop-shadow-md text-white w-sm mx-auto xl:text-2xl xl:w-4xl">Explora todas las categorías.</h2>
            </div>           
        </div>
    ...
    <!-- Main modal -->
                            ...
                            <section class="h-40 mx-auto mb-40 flex items-center justify-center">           
                                    <div class="flex flex-col flex-wrap items-center justify-center">   
                                        <div class="bg-color3 w-sm mx-auto rounded-xl shadow-xl">                                              
                                            <h2 class="text-2xl my-4 font-bold tracking-tight text-white text-center">No hay resultados</h2>                                              
                                        </div>          
                                    </div>        
                            </section>
                        ';
        ...
        <script>
            const buscaCat = "<?php echo isset($buscaCat) ? addslashes($buscaCat) : ''; ?>";
        ...
        function cargarPublicaciones() {
            ...
            fetch(`../Controlador/control_buscadorCategoria.php?action=getPosts&offset=${offset}&opcion=${encodeURIComponent(buscaCat)}`)
