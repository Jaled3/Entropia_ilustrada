<main>
    ...
    <section class="h-200 sm:h-150 flex flex-col justify-center bg-fixed bg-center bg-no-repeat bg-[url('../ServidorImg/estanteria.jpg')] bg-gray-700 bg-blend-multiply">
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <div class="flex flex-col justify-center my-10">
                ...
                <h2 class="text-xl drop-shadow-md text-white w-sm mx-auto xl:text-2xl xl:w-4xl">Busca la obra por su nombre.</h2>
            </div>           
        </div>
    ...
    <!-- Main modal -->
        ...
        function cargarPublicaciones() {
            ...
            fetch(`../Controlador/control_buscador.php?action=getPosts&offset=${offset}&nom=${encodeURIComponent(buscaNom)}`)
