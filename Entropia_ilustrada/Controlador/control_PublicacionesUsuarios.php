...
/*Cargar solo las publicaciones del Usuario Seleccionado*/
function cargarPublicacionesUsuario() {
    ...
    /*Se cargarán las publicaciones de un usuario en específico*/
    $lista = $pub->publicacionesIdUsuario($idUsu, 0, 10);
    ...
    require_once('../Vista/General/publicacionesUsuario.php');
...
if (isset($_GET['action']) && $_GET['action'] == 'getPosts') {
    ...
    $pub = new publicaciones();
    $lista = $pub->publicacionesIdUsuario($idUsu, $offset, $limit);
