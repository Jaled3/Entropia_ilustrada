    ...
    <section class="h-auto mx-auto flex items-center p-10 justify-center bg-center bg-repeat bg-[url('../ServidorImg/patron.jpg')] bg-gray-600 bg-blend-multiply">           
                        ...
                        <section class="h-40 mx-auto mb-40 flex items-center justify-center">           
                            <div class="flex flex-col flex-wrap items-center justify-center">   
                                <div class="bg-color3 w-sm mx-auto rounded-xl shadow-xl">                                              
                                    <h2 class="text-2xl my-4 font-bold tracking-tight text-white text-center">No hay reportes</h2>                                              
                                </div>          
                            </div>        
                        </section>
                    ';
        ...
        <script>
            ...
            function cargarReportes() {
                ...
                fetch(`../Controlador/control_reportes.php?action=getReportesAjax&offset=${offset}`)
                .then(res => res.json())
                .then(data => {
                    if (Object.keys(data).length > 0) {
                        ...
                        for (const [id, rep] of reportes) {
                            ...
                            switch (rep[4]) {
                                case 'activo':
                                    estadoImg = '<img src="../ServidorImg/activo.png" width=50px height=50px class=rounded>';
                                    break;
                                case 'anulado':
                                    estadoImg = '<img src="../ServidorImg/anulado.png" width=50px height=50px class=rounded>';
                                    break;
                                case 'valido':
                                    estadoImg = '<img src="../ServidorImg/valido.png" width=50px height=50px class=rounded>';
                                    break;
                            }
                            ...
                            div.innerHTML = `
                                ...
                                <div class="flex flex-wrap items-center justify-center md:justify-between text-center gap-3 my-8">
                                    ...
                                    <div class="flex items-center justify-center text-center">
                                        ...
                                        <h2 class="text-xl tracking-tight text-white">${rep[9]}</h2>                                        
                                    </div>
