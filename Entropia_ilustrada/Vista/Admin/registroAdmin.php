<main>
    ...
    <section class="mt-15 h-200 mx-auto flex items-center justify-center bg-center bg-no-repeat bg-[url('../ServidorImg/libreria.jpg')] bg-gray-700 bg-blend-multiply">           
        <div class="w-full max-w-sm p-4 bg-gray-800 border border-gray-700 rounded-lg shadow-sm sm:p-6 md:p-8">
            <form class="space-y-6" action="../Controlador/control_perfilUsuarioAdministrador.php?action=registrarAdministrador" method="POST">
            ...
            ?>
                ...
                <div>
                    ...
                    <select name="estado" required class="border text-sm rounded-lg focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex">
                    <span class="inline-flex items-center px-3 text-sm border border-e-0 border-gray-300 rounded-s-md bg-gray-600 text-gray-400 border-gray-600">
                    ...
                    <input type="text" name="correo" id="cor" class="rounded-none rounded-e-lg border focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Correo Electronico" maxlength="100" required >                  
                </div>
